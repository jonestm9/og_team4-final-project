...
# TODO: This entire zmq file needs to be adapted to our stuff
...
def driver (type, contents, code, port):
...
def parseCmdLineArgs ():
    ...
    #TODO: Change the server port to the three types of messages
...
def main ():
  ...
  driver (parsed_args.type, parsed_args.contents, parsed_args.code, parsed_args.port)
