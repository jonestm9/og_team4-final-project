...
def driver (name, iters, vec_len, addr, port):
...
def parseCmdLineArgs ():
    ...
    parser.add_argument ("-a", "--addr", default="localhost", help="IP Address of server")
...
def main ():
  ...
  driver (parsed_args.name, parsed_args.iters, parsed_args.veclen, parsed_args.addr, parsed_args.port)
